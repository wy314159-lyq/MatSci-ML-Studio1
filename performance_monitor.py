...
class SystemMonitorWorker(QThread):
    ...
    def run(self):
        ...
        while self.running:
            try:
                ...
                print("System monitor error:", str(e))
    ...
    def collect_system_stats(self):
        ...
        try:
            ...
            print("Error collecting system stats:", str(e))
            return {}
...
CPU Usage: {stats['process']['cpu_percent']:.1f}%"""
            ...
            print("Error updating system stats:", str(e))
    ...
    def update_task_history_table(self):
        ...
        try:
            ...
            print("Error updating task history:", str(e))
    ...
    def export_performance_report(self):
        ...
        try:
            ...
            if file_path:
                ...
                print("Performance report exported to:", str(file_path))
                
        except Exception as e:
            print("Export report failed:", str(e))
